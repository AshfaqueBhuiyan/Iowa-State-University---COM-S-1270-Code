# Ash Bhuiyan             07-18-2025
# Assignment #4

# Description: This script implements a version of the classic Connect Four board game. It allows either one player (against a simple AI) or two players
#              to take turns dropping pieces into a 6x7 grid, trying to align four of their pieces in a row horizontally, vertically, or diagonally.
#              The game includes turn switching, win and draw detection, and a text-based interface.
    ...
    while running:
        ...
        if choice == "p":
            ...
            while True:
                ...
                # check if the game is over - if it is, break out of the gameplay loop
                if winner == True:
            ...
            print("  The 'instructions' of the game is thus:")
